...
public class SimpleDirectoryWatchService implements DirectoryWatchService, Runnable
{
            ...
            throws IOException
    {
        ...
        System.out.println("log = "+"Watching files matching " + Arrays.toString(globPatterns)
    ...
    public void run()
    {
        System.out.println("log = "+"Starting file watcher service.");
        ...
        while (mIsRunning.get())
        {
            ...
            {
                System.out.println("log = "+"Watch key not recognized.");
                continue;
            }
        ...
        mIsRunning.set(false);
        System.out.println("log = "+"Stopping file watcher service.");
    }
}
